    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <span style="font-size: 25px" class="m-0 font-weight-bold text-primary">Thêm mới Size</span>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <form action="{{ route('capacities.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Thêm mới Size</h4>
                                    </div><!-- end card header -->
                                    <div class="card-body">
